...
const config = Object.freeze({
  ...
  OPENAI_COMPLETION_MODEL: env.OPENAI_COMPLETION_MODEL || 'davinci:ft-personal:fine-tune-familytest-v01-010323-2023-01-03-04-11-52',
  OPENAI_COMPLETION_TEMPERATURE: Number(env.OPENAI_COMPLETION_TEMPERATURE) || 0.9,
  OPENAI_COMPLETION_MAX_TOKENS: Number(env.OPENAI_COMPLETION_MAX_TOKENS) || 192,
